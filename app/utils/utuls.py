...
class RoleDefinition:
    ...
    @property
    def get_role(self):
        people = self.__carts.count("people") + (
            self.__carts.count("people_x2") * 2
        )
        machine = self.__carts.count("machine") + (
            self.__carts.count("machine_x2") * 2
        )
        outcast = self.__carts.count("outcast") + (
            self.__carts.count("outcast_x2") * 2
        )
